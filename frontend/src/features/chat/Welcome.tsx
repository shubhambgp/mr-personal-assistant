...
const STARTERS = [
  ...
  { label: 'Pending visits', prompt: 'Which of my visits are pending this month?', Icon: Stethoscope },
  { label: 'My scorecard', prompt: 'How am I doing against my targets this month?', Icon: Gauge },
  { label: 'Doctors by specialty', prompt: 'How many doctors do I cover, by specialty?', Icon: Users },
]
    ...
    <div className="scrollbar-thin flex h-full min-w-0 items-center justify-center overflow-y-auto px-4 py-8">
      <div className={`${CONTENT_COL} max-w-2xl text-center`}>
        ...
        <p className="mx-auto mt-2 max-w-md text-sm text-fg-muted">
          Ask about your doctors, visits or performance — or attach a photo of a prescription,
          RCPA sheet or stock board and I’ll read it.
        </p>
